...
class LeafyTreeTest extends TreeTest {
    ...
    void growTesting() {
        ...
        assertEquals((2*2),leafyTree.GetLeavesNumber(),"Needles should be 4 after first growing");

        leafyTree.grow(3);
        assertEquals((2+3), tree.GetBranchesNumber(), "Branches should be 2 after second growing");
        assertEquals((2*2+3*2),leafyTree.GetLeavesNumber(),"Needles should be 4 after second growing");
    }
